import { f as createLucideIcon, ao as useGetMonthlyLogs, ap as useGetTargets, aq as useSaveMonthlyLog, r as reactExports, b as ue, j as jsxRuntimeExports, m as motion, x as CalendarDays, T as Target, V as Clock, L as Label, I as Input, e as Progress, S as Pencil, ar as useGetQuestionProgress, as as useGetPlanCycles, at as useGetCustomSubjects, au as useSetQuestionCount, av as useSavePlanCycle, aw as useSaveSectionTimeLog, B as Button, P as Palette, A as AlertDialog, y as AlertDialogTrigger, E as Eraser, z as AlertDialogContent, G as AlertDialogHeader, H as AlertDialogTitle, J as AlertDialogDescription, K as AlertDialogFooter, M as AlertDialogCancel, N as AlertDialogAction, C as CirclePlus, a5 as Timer, a as BookOpen, W as ScrollArea, a4 as Zap } from "./index-CkkKRQCz.js";
import { B as Badge } from "./badge-B1POrxcO.js";
import { C as Card, c as CardContent, a as CardHeader, b as CardTitle } from "./card-CRESsubl.js";
import { C as ChartPie, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, R as ResponsiveContainer, P as PieChart, d as Pie, e as Cell, T as Tooltip, L as Legend, g as DialogDescription, f as DialogFooter } from "./PieChart-CgC9LU1m.js";
...
import { T as TargetsPanel, a as Table, b as TableHeader, c as TableRow, d as TableHead, e as TableBody, f as TableCell } from "./TargetsPanel-DGq3gQWe.js";
import { F as Flame } from "./flame-BhYC09KX.js";
...
import { u as useSectionStyle, S as SectionStylePanel, R as RotateCcw } from "./SectionStylePanel-C0rTiG5h.js";
import { T as Trophy, H as History } from "./trophy--vyJKZz5.js";
import { A as Award } from "./award-C35xMstv.js";
import { P as Pause, a as Play } from "./play-95YI0khn.js";
import "./check-BVWYkXo8.js";
import "./settings-DZpPFEmq.js";
/**
...
function QuestionsTab({
  ...
  const [resetPickedDate, setResetPickedDate] = reactExports.useState(today);
  const [daysUntilReset, setDaysUntilReset] = reactExports.useState(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-4xl mx-auto", style: sectionStyle, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    title: daysUntilReset > 0 ? `Reset available in ${daysUntilReset} days` : "Reset 30-day challenge",
                ...
                daysUntilReset > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground font-medium whitespace-nowrap", children: [
                  "Reset in ",
                  daysUntilReset,
                  "d"
                ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showResetDialog, onOpenChange: setShowResetDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "font-display flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { size: 16, className: "text-red-500" }),
              "Reset 30-Day Challenge"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-muted-foreground text-sm", children: "Choose a new start date for your 30-day challenge window." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "New start date" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "date",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-red-500/30 bg-red-500/5 p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-red-400 leading-relaxed", children: [
              "⚠️ This will clear ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "all challenge progress" }),
              " and start a fresh 30-day window from the selected date. You",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "cannot reset again for 30 days" }),
              "."
            ] }) })
          ] }),
